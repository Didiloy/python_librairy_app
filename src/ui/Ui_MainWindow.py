...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.homeWidget)
        ...
        self.verticalLayout_10.addWidget(self.labelRecommendations, 0, QtCore.Qt.AlignHCenter)
        ...
        self.scrollAreaRecommendationAuteurContent.setGeometry(QtCore.QRect(0, 0, 808, 119))
        ...
        self.verticalLayout_10.addWidget(self.widgetRecommendationParAuteur)
        ...
        self.scrollAreaRecommendationGenreContent.setGeometry(QtCore.QRect(0, 0, 826, 136))
        ...
        self.verticalLayout_10.addWidget(self.widgetRecommendationGenre)
        ...
        self.labelImageBlague = QtWidgets.QLabel(self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelImageBlague.setMaximumSize(QtCore.QSize(600, 160))
        self.labelImageBlague.setText("")
        self.labelImageBlague.setObjectName("labelImageBlague")
        self.gridLayout_5.addWidget(self.labelImageBlague, 0, 0, 1, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout_5.addWidget(self.buttonBlague, 0, 1, 1, 1)
        self.verticalLayout_13.addWidget(self.widget_2)
        self.verticalLayout_10.addWidget(self.widgetBlague)
