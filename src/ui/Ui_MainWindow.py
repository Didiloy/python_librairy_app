...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 860, 604))
...
"}")
        ...
        self.scrollAreaBibliothequeWidgetContent.setGeometry(QtCore.QRect(0, 0, 862, 635))
        ...
        self.recommendationGenreWidget = QtWidgets.QWidget()
        self.recommendationGenreWidget.setObjectName("recommendationGenreWidget")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.recommendationGenreWidget)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.recommendationGenreLabel = QtWidgets.QLabel(self.recommendationGenreWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        self.recommendationGenreLabel.setFont(font)
        self.recommendationGenreLabel.setStyleSheet("")
        self.recommendationGenreLabel.setObjectName("recommendationGenreLabel")
        self.verticalLayout_11.addWidget(self.recommendationGenreLabel, 0, QtCore.Qt.AlignHCenter)
        self.scrollAreaRecommendationGenre = QtWidgets.QScrollArea(self.recommendationGenreWidget)
        ...
        self.scrollAreaRecommendationGenreWidgetContent = QtWidgets.QWidget()
        self.scrollAreaRecommendationGenreWidgetContent.setGeometry(QtCore.QRect(0, 0, 862, 635))
        self.scrollAreaRecommendationGenreWidgetContent.setObjectName("scrollAreaRecommendationGenreWidgetContent")
        self.gridLayout_8 = QtWidgets.QGridLayout(self.scrollAreaRecommendationGenreWidgetContent)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.widget_3 = QtWidgets.QWidget(self.scrollAreaRecommendationGenreWidgetContent)
        ...
        self.scrollAreaRecommendationGenre.setWidget(self.scrollAreaRecommendationGenreWidgetContent)
        self.verticalLayout_11.addWidget(self.scrollAreaRecommendationGenre)
        self.stackedWidget.addWidget(self.recommendationGenreWidget)
        self.recommendationAuteurWidget = QtWidgets.QWidget()
        self.recommendationAuteurWidget.setObjectName("recommendationAuteurWidget")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(self.recommendationAuteurWidget)
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.recommendationAuteurLabel = QtWidgets.QLabel(self.recommendationAuteurWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        self.recommendationAuteurLabel.setFont(font)
        self.recommendationAuteurLabel.setStyleSheet("")
        self.recommendationAuteurLabel.setObjectName("recommendationAuteurLabel")
        self.verticalLayout_14.addWidget(self.recommendationAuteurLabel, 0, QtCore.Qt.AlignHCenter)
        self.scrollAreaRecommendationAuteur = QtWidgets.QScrollArea(self.recommendationAuteurWidget)
        ...
        self.scrollAreaRecommendationAuteurWidgetContent = QtWidgets.QWidget()
        self.scrollAreaRecommendationAuteurWidgetContent.setGeometry(QtCore.QRect(0, 0, 862, 635))
        self.scrollAreaRecommendationAuteurWidgetContent.setObjectName("scrollAreaRecommendationAuteurWidgetContent")
        self.gridLayout_9 = QtWidgets.QGridLayout(self.scrollAreaRecommendationAuteurWidgetContent)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.widget_4 = QtWidgets.QWidget(self.scrollAreaRecommendationAuteurWidgetContent)
        ...
        self.scrollAreaRecommendationAuteur.setWidget(self.scrollAreaRecommendationAuteurWidgetContent)
        self.verticalLayout_14.addWidget(self.scrollAreaRecommendationAuteur)
        self.stackedWidget.addWidget(self.recommendationAuteurWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.buttonBlague.setText(_translate("MainWindow", "Je veux une blague !"))
        self.bibliothequeLabel.setText(_translate("MainWindow", "Bibliothèque"))
        self.recommendationGenreLabel.setText(_translate("MainWindow", "Mes recommandations par genre"))
        self.recommendationAuteurLabel.setText(_translate("MainWindow", "Mes recommandations par auteur"))
