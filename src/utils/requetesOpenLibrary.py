...
class RequetesOpenLibrary:
    ...
    def globalSearch(self, search):
        ...
        if response.status_code == 200 : # Si ça c'est bien passé
            ...
            self.ui.labelRechercheEnCours.setText("Problème de connexion, veuillez réessayer")
    ...
    def recommendationGenre(self):
        ...
        if response.status_code == 200 : # Si tout c'est bien passé
            ...
            self.ui.recommendationGenreLabel.setText("Problème de connexion")
